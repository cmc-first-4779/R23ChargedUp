...
public class PositionSetpoints {
    ...
    public static final double EXTENDER_POSITION_PICKUP_CONE = 49373;
    public static final double EXTENDER_POSITION_AUTO_PICKUP_CONE = 54373;
    public static final double WRIST_POSITION_PICKUP_CONE = 21; // Old value: 42.75;
    ...
    public static final double WRIST_POSITION_PICKUP_CUBE = 22.5; 
    ...
    public static final double SHOULDER_POSITION_DOUBLE_HPS = 80000;
    public static final double EXTENDER_POSITION_DOUBLE_HPS = 4088;
    public static final double WRIST_POSITION_DOUBLE_HPS = 34.5; 
