...
public class WinchHighConeCommand extends CommandBase {
  WinchSubsystem winchSubsystem;
  /** Creates a new WinchGroundCommand. */
  public WinchHighConeCommand(WinchSubsystem winchSubsystem) {
  ...
  public void initialize() {
    ...
    winchSubsystem.setWinchPositionMM(Constants.WINCH_POSITION_HIGH_CONE_NODE);
  }
  ...
  public void execute() {
        ...
        SmartDashboard.putString("Winch Target Position", "HIGH CONE");
  }
