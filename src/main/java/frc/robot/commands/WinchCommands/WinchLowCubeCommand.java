...
public class WinchLowCubeCommand extends CommandBase {
  WinchSubsystem winchSubsystem;
  /** Creates a new WinchGroundCommand. */
  public WinchLowCubeCommand(WinchSubsystem winchSubsystem) {
  ...
  public void initialize() {
    ...
    winchSubsystem.setWinchPositionMM(Constants.WINCH_POSITION_LOW_CUBE_NODE);
  }
  ...
  public void execute() {
        ...
        SmartDashboard.putString("Winch Target Position", "LOW CUBE");
  }
