...
public class WinchLowConeCommand extends CommandBase {
  WinchSubsystem winchSubsystem;
  /** Creates a new WinchGroundCommand. */
  public WinchLowConeCommand(WinchSubsystem winchSubsystem) {
  ...
  public void execute() {
        ...
        SmartDashboard.putString("Winch Target Position", "LOW CONE");
  }
