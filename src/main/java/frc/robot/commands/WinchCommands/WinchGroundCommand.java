...
public class WinchGroundCommand extends CommandBase {
  WinchSubsystem winchSubsystem;
  /** Creates a new WinchGroundCommand. */
  public WinchGroundCommand(WinchSubsystem winchSubsystem) {
  ...
  public void initialize() {
    ...
    winchSubsystem.setWinchPositionMM(Constants.WINCH_POSITION_GROUND);
  }
  ...
  public void execute() {
        ...
        SmartDashboard.putString("Winch Target Position", "GROUND");
  }
