...
public class WinchMidConeCommand extends CommandBase {
  WinchSubsystem winchSubsystem;
  /** Creates a new WinchGroundCommand. */
  public WinchMidConeCommand(WinchSubsystem winchSubsystem) {
  ...
  public void initialize() {
    ...
    winchSubsystem.setWinchPositionMM(Constants.WINCH_POSITION_MID_CONE_NODE);
  }
  ...
  public void execute() {
        ...
        SmartDashboard.putString("Winch Target Position", "MID CONE");
  }
