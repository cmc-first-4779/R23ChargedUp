...
public class WinchHighCubeCommand extends CommandBase {
  WinchSubsystem winchSubsystem;
  /** Creates a new WinchGroundCommand. */
  public WinchHighCubeCommand(WinchSubsystem winchSubsystem) {
  ...
  public void initialize() {
    ...
    winchSubsystem.setWinchPositionMM(Constants.WINCH_POSITION_HIGH_CUBE_NODE);
  }
  ...
  public void execute() {
        ...
        SmartDashboard.putString("Winch Target Position", "HIGH CUBE");
  }
