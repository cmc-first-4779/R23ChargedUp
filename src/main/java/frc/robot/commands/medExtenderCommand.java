...
public class medExtenderCommand extends CommandBase { 
  ExtenderSubsystem m_extenderSubsystem; 
  double currentencoderposition;
  /** Creates a new lowExtenderCommand. */
  public medExtenderCommand(ExtenderSubsystem extenderSubsystem) {
 ...
 addRequirements(m_extenderSubsystem);
  ...
  public boolean isFinished() {
    return currentencoderposition >= Constants.EXTENDER_MED_POSITION;
  }
}
