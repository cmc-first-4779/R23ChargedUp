...
///  This Command sets the position to the setpoints that are working for Auton.

public class AutoSetToPositionPCG extends ParallelCommandGroup {
  ...
  public AutoSetToPositionPCG(String position, ShoulderSubsystem shoulder, ExtenderSubsystem extender, WristSubsystem wrist) {
    ...
    switch (position) {
      ...
      case "PICKUP_CONE":
        ...
        extenderPosition = PositionSetpoints.EXTENDER_POSITION_AUTO_PICKUP_CONE;
