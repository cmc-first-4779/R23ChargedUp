...
public final class Constants {
  ...
  public static final double EXTENDER_SM_MIN_VEL = 2000; // Dummy variable - Test this!
  public static final double EXTENDER_SM_MAX_ACCEL = 2000; // Dummy variable - Test this!
