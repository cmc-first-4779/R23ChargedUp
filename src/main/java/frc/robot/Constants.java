...
public final class Constants {
  ...
  // Intake Constants
  public static final double INTAKE_CONE_SPEED = -0.85;
  public static final double INTAKE_CUBE_SPEED = 0.65;
  public static final double EJECT_CONE_SPEED = 0.75;
  public static final double EJECT_CUBE_SPEED = -0.55;
  public static final double EJECT_CUBE_SPEED_AUTON1 = 0.77;
  public static final double EJECT_CUBE_SPEED_FROMSTOW = 0.52;
  ...
  public static final double SHOULDER_ABSOLUTE_ENCODER_OFFSET = 0.6207; // Absolute position of encoder when arm is at 0 between 0.0 and 1;
  ...
  public static final double WRIST_ABSOLUTE_ENCODER_OFFSET = 0.5620;
 ...
 // LIMELIGHT Constants
  ...
  public static final double LIMELIGHT_Y_DRIVE_TOLERANCE = 0.10;
  //  Minimum throttle it takes to move the robot.
  public static final double LIMELIGHT_MIN_MOVE = 0.18;
}
